...
const AboutEcommerce = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 items-center min-h-screen bg-blue-100 p-6 gap-6">
  
      <div className="flex justify-center items-center md:w-full">
        <img 
          src="/images/ecomm.jpg" 
          alt="E-commerce Products" 
          className="w-full md:w-[90%] lg:w-[700px] h-auto object-contain rounded-lg"
        />
      </div>
      ...
      <div className="p-4 md:p-10 flex flex-col justify-center">
        ...
        <p className="mt-4 text-left lg:text-justify text-gray-700 text-lg">
