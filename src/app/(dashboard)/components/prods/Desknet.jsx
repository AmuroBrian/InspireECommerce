...
const product = {
  ...
  image: "./images/b2.jpg",
  description:
    "Desknet's NEO is a cloud-based groupware popular in Japan, offering businesses a customizable platform for collaboration, communication, and workflow management.",
    ...
    <div className="flex flex-col md:flex-row items-start p-8 max-w-4xl mx-auto border rounded-lg shadow-lg">
      ...
      <div className="w-full md:w-1/2 px-6">
        ...
        {product.price ? (
          ...
          <p className="text-lg font-semibold mt-4 text-red-500">Price to be discussed</p>
        )}
