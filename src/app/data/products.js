const products = [
    {
        ...
        info: "You Be You contains natural ingredients that makes it excellent for daily use. It has two variations, Daily Morning Mask and for Daily Night Mask, to help achieve the effect. You Be You offers two types of packages, one 7 mask sheets, and the other 30 mask sheets.",
